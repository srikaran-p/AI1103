...
\end{align*}
Let $c$ be the number of heads in an event in $\Omega$,
\begin{align*}
    X &= 2c - 1.5(3 - c) \\
    X &= 3.5c - 4.5 \\
    X &=
    ...
    \end{cases}
\end{align*}
The value of $X$ is dependent on the value of $c$. As the value of $c$ is probabilistic in nature, it is a random variable. As $c$ is a random variable, we can say that $X$ is a random variable. $\square$
\begin{figure}[htp]
    \centering
